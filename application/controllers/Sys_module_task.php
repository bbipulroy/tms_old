...
class Sys_module_task extends Root_Controller
{
    ...
    {
        $this->db->from($this->config->item('system_db_tms').'.'.$this->config->item('table_system_task'));
    ...
    private function system_save()
    {
        ...
        else
        {
            ...
            if($id>0)
            {
                ...
                Query_helper::update($this->config->item('system_db_tms').'.'.$this->config->item('table_system_task'),$data,array("id = ".$id));
            ...
            else
            {
                ...
                Query_helper::add($this->config->item('system_db_tms').'.'.$this->config->item('table_system_task'),$data);
            }
